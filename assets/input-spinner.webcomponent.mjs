...
let InputSpinner = _decorate([n$1('input-spinner')], function (_initialize, _LitElement) {
  class InputSpinner extends _LitElement {
    constructor() {
      super();
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return css`:host {
            display: inline;
    --background-color: var(--tlx-background-color, indianred);
    ...
    --button-size: var(--tlx-button-size, 1.1em);
    --button-border: var(--tlx-button-border, 2px solid black);
    --button-font-size: var(--tlx-button-font-size, 1.2em);
...
`;
      ...
      value: function render() {
        return html`<div class="container">
            <div class="btn prev" @click="${this.down}"></div>
            <div class="value">${this.value}</div>
            <div class="btn next" @click="${this.up}"></div>
        </div>`;
      }
    }, {
      kind: "get",
      ...
      value: function validationMessage() {
...
export { InputSpinner as default };
